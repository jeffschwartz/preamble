...
<div class="warning">
<strong>Heads up!</strong> These docs are for v2.0, which is no longer officially supported. For more recent versions please see <a href="{{ site.baseurl }}/docs/">Guides & Resources</a>.
</div>
