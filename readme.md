...
Because of the extent and nature of the features that have been added, _test scripts written for previous versions will not work_. In addition, _numerous APIs have been added, changed or removed entirely_. This was unfortunate but absolutely necessary in order to move Preamble forward. Please read the documentation for complete details.
